...
public class ViewFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState){
        ...
        //insercion de datos para la validacion del boton para pasar a la siguiente interfaz
        ...
        loginButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(!isPasswordValid(passwordEditText.getText())){
                    ...
                    //navegacion hacia otro FragmentLayout
                    ((NavigationHost) getActivity()).navigateTo(new HomeFragment(), false);
                }
            }
        });

        //Limpia el error presente al corregir los parametros aceptados en el campo
